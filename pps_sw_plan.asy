...
AddTask("re8", "Calibration Record for HPTDC nonlinearities compensation", ass="Chris", cons="", resp="", stat="merged", pr="36537");

AddTask("re9", "HPTDC nonlinearities compensation", ass="Chris", cons="", resp="", stat="merged", pr="36713", dep=deps("re8"));

AddTask("re10", "XML and FedId configuration update", ass="Chris", cons="", resp="", stat="merged", pr="37147");

AddTask("re11", "removing temporary GT access from diamond Reco", ass="Helena", cons="AlCa", resp="", stat="merged", pr="37034");

AddTask("re12", "XML configuration hotfix", ass="Chris", cons="", resp="", stat="merged", pr="37449");

AddTask("re13", "XML configuration hotfix (backport to 12\_3)", ass="Chris", cons="", resp="", stat="merged", pr="37450", dep=deps("re12"));
...
AddTask("re18", "Fix for hardcoded subdetector id (backport to 12\_3)", ass="Chris", cons="", resp="", stat="merged", pr="38232", flags="new-gm,new-swm", dep=deps("re17"));

AddTask("re19", "Fix for hardcoded subdetector id (backport to 12\_4)", ass="Chris", cons="", resp="", stat="merged", pr="38231", flags="new-gm,new-swm", dep=deps("re17"));
...
AddTask("ds5", "direct simulation as a standard sequence", pri="", ass="Laurent", stat="open", resp="POG", due="", dep=deps(), pr="38280", flags="new-gm" );
...
AddTask("dqm10", "timing RPs -- update diamond DQM", ass="Chris", resp="DPG", stat="merged", pr="35454");

AddTask("dqm11", "common module -- update RP ids", ass="Jan", resp="DPG", stat="merged", pr="35484");
...
AddTask("dqm9", "include PPS to T0 processing", ass="Fabrizio", resp="DPG", stat="open", pr="https://github.com/dmwm/T0/pull/4588", comments="", dep=deps("pcl13"));

AddTask("dqm12", "use Run3 era in online DQM, fix in master", ass="Jan", stat="merged", pr="35550");

AddTask("dqm13", "use Run3 era in online DQM, backport to 12\_0", ass="Jan", stat="merged", pr="35551", dep=deps("dqm12"));
...
AddTask("pcl5", "alignment -- update of config classes", ass="Mateusz", cons="Jan", resp="DPG", stat="merged", pr="35174", dep=deps());

AddTask("pcl6", "alignment -- upload of alignment config", ass="Mateusz,Wagner", cons="Jan", resp="DPG", stat="done", pr="", dep=deps("pcl5"));

AddTask("pcl7", "alignment -- PCL-like matrix workflow", ass="Mateusz", cons="Jan", resp="DPG", stat="merged", pr="35631", dep=deps("pcl6"));
...
AddTask("pcl9", "fix of alignment matrix test", ass="Mateusz", cons="Jan", resp="DPG", stat="merged", pr="35874",
	dep=deps("pcl7"), comments="
details in \ulink{https://github.com/cms-sw/cmssw/issues/35764}{here}
");

AddTask("pcl10", "fix of timing calibration matrix test", ass="Chris", cons="", resp="DPG", stat="merged", pr="35988");

AddTask("pcl11", "AlCaReco producer for PPS calibrations", ass="Andrea", cons="Leszek", resp="AlCa", stat="merged", pr="36273");

AddTask("pcl12", "alignment -- reformatting, readme", ass="Mateusz", cons="", resp="", stat="merged", pr="36257");

AddTask("pcl13", "renaming of AlCa reco producers for Tier0 replay", ass="Leszek", cons="AlCa", resp="AlCa", pr="36702", stat="merged");

AddTask("pcl14", "new AlCa reco producer support in PCL workers", ass="Mateusz", cons="AlCa", resp="AlCa", pr="37050", stat="merged", dep=deps("pcl11"));
