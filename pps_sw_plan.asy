...
AddTask("re6", "N-F association cuts: bugfix for crash on DB read", ass="Jan", cons="", resp="", stat="merged", pr="35941", flags="new-swm, new-gm", dep=deps("re7"));
...
AddTask("val2", "dLyds perturbation scenario for modified optics", ass="Frizi", stat="open", pr="36039", flags="new-swm,new-gm", comments="implemented in modified optics ES generator");
